  ...
  return (
    <div className="privacy">
      ...
      <div style={{ margin: "auto", width: "100%" }}>
        <p>
          At cewa.in, accessible from https://cewa.in, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by cewa.in and how we use it.
          <br />
          ...
          shared and/or collect in cewa.in. This policy is not applicable to any
          information collected offline or via channels other than this website.
          Our Privacy Policy was created with the help of the Online Generator
          of Privacy Policy.
        </p>
        <h2>Consent</h2>
        <p>
        ...
        <h2> Log Files</h2>
        <p>
          cewa.in follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, cewa.in uses 'cookies'. These cookies are used
          ...
          from Cookie Consent. Google DoubleClick DART Cookie Google is one of a
        ...
        <h2>Partners Privacy Policies</h2>{" "}
        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of cewa.in. Third-party ad servers or ad networks
          ...
          cewa.in, which are sent directly to users' browser. They automatically
          ...
          visit. Note that cewa.in has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          cewa.in's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          cewa.in does not knowingly collect any Personal Identifiable
